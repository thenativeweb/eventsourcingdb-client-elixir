defmodule EventsourcingdbTest.ReadEvents do
  ...
  test "read from exact topic", %{esdb: esdb} do
    ...
    assert assert_event_match_eventcandidate(Enum.at(events, 0), event_candidate, nil, nil)
  end
  ...
  test "read not recursive", %{esdb: esdb} do
    ...
    assert assert_event_match_eventcandidate(Enum.at(events, 0), event_candidate_parent, nil, nil)
  end
